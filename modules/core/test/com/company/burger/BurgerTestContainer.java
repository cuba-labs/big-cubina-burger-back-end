...
public class BurgerTestContainer extends TestContainer {

    public BurgerTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/burger/app.properties",
    ...
    public static class Common extends BurgerTestContainer {

        public static final BurgerTestContainer.Common INSTANCE = new BurgerTestContainer.Common();
